...
@pytest.fixture
def deploy_price_exercise(get_oracle, get_job_id, chainlink_fee, get_link_token, get_eth_usd_price_feed_address):
    # Arrange
...
def test_send_api_request_local(
    ...
    # Assert
    get_oracle.fulfillOracleRequest(requestId, get_data, {"from": get_account()})
